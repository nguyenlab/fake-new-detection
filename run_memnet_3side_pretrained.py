...
from memnet.memnet_3side import MemNet, eval
import numpy as np
import tensorflow as tf
import itertools

tf.flags.DEFINE_integer("num_epochs", 600, "number of epochs")
# ch + party stop at 13
...
tf.flags.DEFINE_integer("side_size", 64, "side size")
...
side_index1 = party_index
train_side1 = train_party
valid_side1 = valid_party
test_side1 = test_party

side_index2 = state_index
train_side2 = train_state
valid_side2 = valid_state
test_side2 = test_state

# compress all data
train_data = zip(train_x, train_sq_len, train_ch, train_side1, train_side2, train_y)
valid_data = zip(valid_x, valid_sq_len, valid_ch, valid_side1, valid_side2, valid_y)
test_data = zip(test_x, test_sq_len, test_ch, test_side1, test_side2, test_y)
...
with graph.as_default():
    with tf.Session() as sess:
        mem_net = MemNet(
            ...
            side1_vocab_size=len(side_index1),
            side2_vocab_size=len(side_index2),
